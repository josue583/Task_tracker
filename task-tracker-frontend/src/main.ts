...
function renderAppScreen() {
  ...
  app.innerHTML = `
    <div class="min-h-screen min-h-[100dvh] bg-gradient-to-br from-slate-900 via-slate-950 to-slate-900 text-slate-100 flex items-center justify-center px-3 sm:px-4 pt-2 pb-[max(1rem,env(safe-area-inset-bottom))] sm:pt-4">
      <div class="w-full max-w-xl max-h-[100dvh] bg-slate-900/70 border border-slate-700/70 backdrop-blur-md rounded-2xl shadow-2xl p-4 sm:p-6 md:p-8 mt-0 mb-1 sm:mt-1 sm:mb-3 space-y-4 sm:space-y-6 overflow-y-auto">
